...
# Priority: 1) live ea_config (EA patches every tick — always freshest)

# 2) latest performance snapshot (fallback if EA offline)
...
ibox(f”💰 <b>Capital Budget:</b> ${tc:,.2f} × {cp:.0f}% = <b>${tc*cp/100:,.2f} effective</b>”,“blue”)
